...
export interface ApiFavouriteVeichleFavouriteVeichle
  extends Schema.CollectionType {
  ...
  attributes: {
    logged_user: Attribute.Relation<
...
export interface ApiLoggedUserLoggedUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    favourite_veichle: Attribute.Relation<
      'api::logged-user.logged-user',
      'oneToOne',
      'api::favourite-veichle.favourite-veichle'
    >;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    fuelType: Attribute.Enumeration<
      ['Ibrido', 'Diesel', 'Elettrico', 'Benzina', 'Gpl', 'Metano']
    >;
    ...
    tractionType: Attribute.Enumeration<
      ['Integrale (4x4)', 'Anteriore', 'Posteriore']
    >;
    carType: Attribute.Enumeration<
      [
        'SUV',
        'Station Wagon',
        'Berlina',
...
export interface ApiRegisterFormRegisterForm extends Schema.CollectionType {
  ...
  attributes: {
    ...
    gender: Attribute.Enumeration<['Uomo', 'Donna', 'Non Specificato']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::favourite-veichle.favourite-veichle': ApiFavouriteVeichleFavouriteVeichle;
      'api::logged-user.logged-user': ApiLoggedUserLoggedUser;
